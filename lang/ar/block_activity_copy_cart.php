...
$string['contentdata_info'] = 'قد تشير قيود الوصول إلى تواريخ أو مجموعات أو درجات غير موجودة في المقرر المستهدف. كما أن نسخ بيانات المستخدمين (كالتسليمات) بين المقررات نادرًا ما يكون مناسبًا.';
$string['keeprestrictions'] = 'الإبقاء على قيود الوصول (التواريخ، المجموعات، شروط الدرجات، وغيرها)';
$string['includeuserdata'] = 'تضمين بيانات المستخدمين';
